...
```bash
npm install @nasy/react-native-sketch-canvas --save
```

Link native code

```bash
react-native link @nasy/react-native-sketch-canvas
```
...
import { SketchCanvas } from "@nasy/react-native-sketch-canvas";
...
import RNSketchCanvas from "@nasy/react-native-sketch-canvas";
...
Please refer [here](https://github.com/nasy/react-native-sketch-canvas/wiki/Troubleshooting).
